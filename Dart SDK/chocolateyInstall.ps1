...
$url = 'https://storage.googleapis.com/dart-archive/channels/stable/release/1.18.0/sdk/dartsdk-windows-ia32-release.zip'
$url64 = 'https://storage.googleapis.com/dart-archive/channels/stable/release/1.18.0/sdk/dartsdk-windows-x64-release.zip'
